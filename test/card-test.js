...
describe('card', function() {
  ...
  it('should create a deck of cards', function() {
    const card1 = createCard(1, 'What is Pareesas favorite color?', ['blue', 'green', 'pink'], 'blue');
    const card2 = createCard(2, 'What is Obisidians favorite snack?', ['beef jerkey', 'cherry tomatoes', 'chicken bones'], 'cherry tomatoes');
